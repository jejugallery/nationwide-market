...
export async function POST(request: Request) {
  try {
    ...
    const { name, accountName, bankName, accountNumber, items, creatorName, creatorPicture, creatorUserId } = body;
    ...
    const orderResult = await sql`
      INSERT INTO orders (name, account_name, bank_name, account_number, creator_name, creator_picture, creator_user_id)
      VALUES (${name}, ${accountName}, ${bankName}, ${accountNumber}, ${creatorName || null}, ${creatorPicture || null}, ${creatorUserId || null})
      RETURNING id
    `;
